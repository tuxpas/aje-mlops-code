...
def create_spark_session():
    ...
    spark = (
        ...
        .appName("SageMaker-ALS-Recommender-PA")
...
def als_training_job(spark, ruta_csv_path):
    """Entrena ALS usando la frecuencia implícita de compras (sin KMeans)."""
    ...
    # Entrenamiento ALS (implícito, sin KMeans, rank=15)
    als = ALS(
        rank=15,
        maxIter=5,
        implicitPrefs=True,
    ...
    client_recs["id_cliente"] = "CAM|" + client_recs["compania"] + "|" + client_recs["cliente"]
...
def main():
    try:
        print("Iniciando Modelado ALS (Panamá - Modo Implícito sin KMeans)...")
